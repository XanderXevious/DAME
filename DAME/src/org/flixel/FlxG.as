package org.flixel
{
	...
	public class FlxG
	{
		...
		static public var forceRefresh:Boolean = false;
		static public var requestRefresh:Boolean = false;
		
		static public var extraScroll:FlxPoint = new FlxPoint;
		static public var extraZoom:Number = 1;
		static public var zoomBitShifter:int = 0;
		static public var invExtraZoom:Number = 1;	// 1/extraZoom
		
		static public var zoomScale:Number = 1;
		static public var disableUpdate:Boolean = false;
		...
		static public var canHideSystemCursor:Boolean = true;
		...
		/**
		 * Removes a bitmap from the cache if present.
		 */
		static public function removeCachedBitmap(Key:String = null):void
		{
			if ( checkBitmapCache(Key) )
			{
				delete _cache[Key];
